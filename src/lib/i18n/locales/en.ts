const en = {
    ...
    voiceCall: {
        ...
        addVideo: 'Add video',
        addVideoUpgrading: 'Adding video…',
        addVideoFailed: 'Couldn\u2019t add video',
        // Group-call specific labels
        groupCall: 'Group call',
        groupCallTooLarge: 'Group calls support up to 4 participants',
        groupCallingNobody: 'Calling…',
        groupCallingSome: 'Ringing {connected} of {total}',
        groupCallStatusActive: 'Connected · {connected}/{total}',
        groupCallParticipantPending: 'Waiting…',
        groupCallParticipantRinging: 'Ringing',
        groupCallParticipantConnecting: 'Connecting',
        groupCallParticipantActive: 'Connected',
        groupCallParticipantEnded: 'Ended',
